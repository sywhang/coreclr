...
clrtracecontext_filename = "clrtracecontexts.h"
etw_dirname = "etw"
replacements = [
...
clrtracecontexts_header="""
/*****************************************************************/
/* DOTNET_TRACE_CONTEXT Definition */
/* Autogenerated by genEtwProvider.py  */
/*****************************************************************/

#include "ClrEtwAll.h"
//
//  EVENTPIPE_PROVIDER_CONTEXT definition
//
...
//
// EVENTPIPE_PROVIDER_CONTEXT definitions for runtime providers
//

EXTERN_C __declspec(selectany) EVENTPIPE_PROVIDER_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_PROVIDER_EVENTPIPE_Context = { W("Microsoft-Windows-DotNETRuntime"), 0, false, 0, 0 };
EXTERN_C __declspec(selectany) EVENTPIPE_PROVIDER_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_RUNDOWN_PROVIDER_EVENTPIPE_Context = { W("Microsoft-Windows-DotNETRuntimeRundown"), 0, false, 0, 1 };
EXTERN_C __declspec(selectany) EVENTPIPE_PROVIDER_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_STRESS_PROVIDER_EVENTPIPE_Context = { W("Microsoft-Windows-DotNETRuntimeStress"), 0, false, 0, 2 };
EXTERN_C __declspec(selectany) EVENTPIPE_PROVIDER_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_PRIVATE_PROVIDER_EVENTPIPE_Context = { W("Microsoft-Windows-DotNETRuntimePrivate"), 0, false, 0, 3 };
...
EXTERN_C __declspec(selectany) DOTNET_TRACE_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_PRIVATE_PROVIDER_DOTNET_Context = { MICROSOFT_WINDOWS_DOTNETRUNTIME_PRIVATE_PROVIDER_Context, MICROSOFT_WINDOWS_DOTNETRUNTIME_RUNDOWN_PROVIDER_EVENTPIPE_Context };

EXTERN_C __declspec(selectany) DOTNET_TRACE_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_RUNDOWN_PROVIDER_DOTNET_Context = { MICROSOFT_WINDOWS_DOTNETRUNTIME_RUNDOWN_PROVIDER_Context, MICROSOFT_WINDOWS_DOTNETRUNTIME_STRESS_PROVIDER_EVENTPIPE_Context };

EXTERN_C __declspec(selectany) DOTNET_TRACE_CONTEXT MICROSOFT_WINDOWS_DOTNETRUNTIME_STRESS_PROVIDER_DOTNET_Context = { MICROSOFT_WINDOWS_DOTNETRUNTIME_STRESS_PROVIDER_Context, MICROSOFT_WINDOWS_DOTNETRUNTIME_PRIVATE_PROVIDER_EVENTPIPE_Context };

"""

def genClrTraceContexts(intermediate):
    provider_dirname = os.path.join(intermediate, etw_dirname + "_temp")
    with open(path.join(provider_dirname, clrtracecontext_filename), 'w') as clrtracecontext_file:
        clrtracecontext_file.write(clrtracecontexts_header)
...
def genProviderInterface(manifest, intermediate):
    ...
    #header_text += mcgen_header_trace_context
...
def genFiles(manifest, intermediate, exclusion_filename):
    ...
    genClrTraceContexts(intermediate)
